...
Shader "EudenVFX/Skybox OOT"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_249_0 = ( 1.0 - step( (normalizeResult245).y , 0.0 ) );
			float HalfDome269 = temp_output_249_0;
			...
			float temp_output_261_0 = pow( ( HalfDome269 * max( ( 1.0 - length( ( ase_worldlightDir - NormalizedSkyCoords144 ) ) ) , 0.0 ) ) , _Float1 );
			float temp_output_251_0 = (NormalizedSkyCoords144).y;
			...
			float4 temp_output_196_0 = ( float4( 0,0,0,0 ) + lerpResult189 );
			...
			o.Emission = ( float4( 0,0,0,0 ) + ( ( temp_output_261_0 + pow( ( 1.0 - abs( temp_output_251_0 ) ) , 12.0 ) ) * temp_output_261_0 ) + lerpResult199 ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17700
384;546;907;389;891.1981;300.0684;1.737295;True;False
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;232;401.9801,-1069.143;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GetLocalVarNode;256;419.5482,-916.8612;Inherit;False;144;NormalizedSkyCoords;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;23;-1850.388,1334.691;Inherit;False;Property;_TopColor2;TopColor2;3;0;Create;True;0;0;False;0;0.5,0.5,0.5,1;0.03844785,0.1034185,0.3018865,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;14;-1870.017,615.8494;Inherit;False;Property;_DayTopColor;DayTopColor;1;0;Create;True;0;0;False;0;0.5,0.5,0.5,1;0.07075446,0.5578593,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;257;917.5935,-1119.254;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;249;-236.8186,322.621;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LengthOpNode;258;1088.239,-1067.664;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;269;306.2017,417.5994;Inherit;False;HalfDome;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;259;1284.679,-1045.837;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;251;1098.987,-283.9455;Inherit;False;False;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;205;-1024.128,1355.915;Inherit;False;Property;_CloudsColor2;Clouds Color 2;14;0;Create;True;0;0;False;0;0.6415094,0.6415094,0.6415094,1;0.102394,0.2516221,0.5566037,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;270;1292.688,-1156.012;Inherit;False;269;HalfDome;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;265;1312.146,-367.5932;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;260;1465.245,-980.3571;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;236;724.871,-554.5585;Inherit;False;Property;_Float1;Float 1;16;0;Create;True;0;0;False;0;10;1.823528;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;271;1594.692,-1059.731;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;264;1449.041,-297.682;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;241;-427.8843,-1268.711;Inherit;False;Property;_HorizonColorNight;HorizonColorNight;6;0;Create;True;0;0;False;0;0,0,0,1;0.1090245,0.2786714,0.6603774,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;263;1617.001,-252.3277;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;12;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;261;1681.194,-873.6634;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;273;1870.996,-853.864;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;196;140.3772,-59.29679;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;267;2015.691,-704.7963;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;255;1097.041,-953.803;Inherit;False;Minus One One To Zero One;-1;;1;19562fcffd7bc41fcb0c40a6194596ae;0;1;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DistanceOpNode;262;1305.07,-249.9062;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;268;2186.879,-589.1097;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.DotProductOpNode;252;914.0445,-995.9478;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;272;1392.811,-106.4016;Inherit;False;Property;_Horizonpower;Horizon power;17;0;Create;True;0;0;False;0;0;12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2403.796,-767.1932;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;EudenVFX/Skybox OOT;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;False;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
