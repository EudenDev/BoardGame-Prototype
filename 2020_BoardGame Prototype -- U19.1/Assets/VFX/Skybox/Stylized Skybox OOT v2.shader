...
Shader "EudenVFX/Skybox OOT v2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult5_g7 = lerp( _BottomNight , _BottomTwi , saturate( temp_output_6_0_g7 ));
			float4 lerpResult4_g7 = lerp( lerpResult5_g7 , _BottomDay , saturate( ( temp_output_6_0_g7 - 1.0 ) ));
			float temp_output_6_0_g6 = ( DayTime01211 * 2.0 );
			float4 lerpResult5_g6 = lerp( _TopNight , _TopTwi , saturate( temp_output_6_0_g6 ));
			float4 lerpResult4_g6 = lerp( lerpResult5_g6 , _TopDay , saturate( ( temp_output_6_0_g6 - 1.0 ) ));
			float4 lerpResult323 = lerp( lerpResult4_g7 , lerpResult4_g6 , HalfDome269);
			...
			float4 lerpResult5_g9 = lerp( _HorizonColorNight , _HorizonColorTwi , saturate( temp_output_6_0_g9 ));
			float4 lerpResult4_g9 = lerp( lerpResult5_g9 , _HorizonColorDay , saturate( ( temp_output_6_0_g9 - 1.0 ) ));
			float4 temp_output_335_0 = lerpResult4_g9;
			...
			float4 lerpResult199 = lerp( ( ( ( 1.0 - saturate( smoothstepResult157 ) ) * HalfDome269 ) + lerpResult189 ) , temp_output_335_0 , temp_output_44_0);
...
/*ASEBEGIN
Version=17700
384;514;907;421;3792.33;604.1821;2.399959;True;False
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;132;-1784.813,-716.2686;Inherit;False;0;3;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;144;-1353.789,-564.8986;Inherit;False;NormalizedSkyCoords;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;342;-2956.303,332.39;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;338;-39.01575,-1243.11;Inherit;False;Property;_HorizonPower;Horizon Power;19;0;Create;True;0;0;False;0;0;10.39;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;345;-2690.272,341.9563;Inherit;False;Minus One One To Zero One;-1;;10;19562fcffd7bc41fcb0c40a6194596ae;0;1;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;311;-2466.584,798.8007;Inherit;False;Property;_TopDay;TopDay;14;0;Create;True;0;0;False;0;0.3806515,0.7481066,0.8867924,1;0,0.5507969,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;319;-2479.539,1416.641;Inherit;False;Property;_BottomDay;BottomDay;17;0;Create;True;0;0;False;0;0.3086062,0.5836833,0.8962264,1;0.6431373,0.9607844,0.972549,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;313;-2046.801,957.0985;Inherit;False;Property;_TopNight;TopNight;16;0;Create;True;0;0;False;0;0.1365348,0.1089356,0.4528302,1;0.1365347,0.1089355,0.4528301,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;318;-2266.507,1498.417;Inherit;False;Property;_BottomTwi;BottomTwi;10;0;Create;True;0;0;False;0;0.8773585,0.5255678,0.2110626,1;0.9647059,0.7529413,0.3411764,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;321;-1758.614,1444.82;Inherit;False;Lerp Triple;-1;;7;9715dbb4962444c64901cea19c13f62b;0;4;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;9;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;39;-1072.347,-649.7302;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;331;-981.5248,762.7759;Inherit;False;Property;_CloudsNight;CloudsNight;13;0;Create;True;0;0;False;0;0.3064703,0.3758842,0.6698113,1;0.1163846,0.1102705,0.3962263,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;314;-1744.659,826.9797;Inherit;False;Lerp Triple;-1;;6;9715dbb4962444c64901cea19c13f62b;0;4;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;9;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;333;-679.3829,632.6572;Inherit;False;Lerp Triple;-1;;8;9715dbb4962444c64901cea19c13f62b;0;4;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;9;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;334;-384.2726,-982.4756;Inherit;False;Property;_HorizonColorTwi;HorizonColorTwi;2;0;Create;True;0;0;False;0;0.9339623,0.703715,0,1;1,0.749069,0.231132,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;46;-171.4519,-1115.864;Inherit;False;Property;_HorizonColorDay;HorizonColorDay;1;0;Create;True;0;0;False;0;0.9339623,0.703715,0,1;0.5507298,0.9688349,0.9811321,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;241;-168.779,-905.9516;Inherit;False;Property;_HorizonColorNight;HorizonColorNight;3;0;Create;True;0;0;False;0;0,0,0,1;0.2843983,0.4201605,0.7264151,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;243;-327.7455,-732.376;Inherit;False;211;DayTime01;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;335;136.6937,-996.7395;Inherit;False;Lerp Triple;-1;;9;9715dbb4962444c64901cea19c13f62b;0;4;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;9;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;339;511.2808,-1190.867;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;336;527.8298,-243.429;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldSpaceLightPos;42;-2986.757,126.142;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SaturateNode;213;-2519.333,124.0135;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;337;231.4581,-506.0475;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;340;288.4814,-1142.336;Inherit;False;Property;_horizonadd;horizon add;20;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;43;-2738.895,184.9463;Inherit;False;False;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
