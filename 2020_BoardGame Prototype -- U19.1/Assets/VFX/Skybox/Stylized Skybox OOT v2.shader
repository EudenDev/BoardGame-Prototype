...
Shader "EudenVFX/Skybox OOT v2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_388_0 = ( lerpResult4_g17 * saturate( ( smoothstepResult387 + ( smoothstepResult387 * Horizon353 ) ) ) );
			float smoothstepResult157 = smoothstep( 0.0 , 2.0 , ( distance( NormalizedSkyCoords144 , ase_worldlightDir ) / _SunRadius ));
			...
			o.Emission = ( ( _SunsetColor * temp_output_388_0 ) + float4( 0,0,0,0 ) + lerpResult199 ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17700
384;514;907;421;1104.615;2472.914;3.584914;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;338;-200.935,-1052.616;Inherit;False;Property;_HorizonPower;Horizon Power;14;0;Create;True;0;0;False;0;0;4.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;340;3.562041,-916.843;Inherit;False;Property;_HorizonOpacity;Horizon Opacity;15;0;Create;True;0;0;False;0;0;1.19;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;320;-1373.047,1513.628;Inherit;False;Property;_BottomNight;BottomNight;13;0;Create;True;0;0;False;0;0.2102617,0.3502325,0.7075472,1;0,0.31232,0.8207547,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;319;-1730.128,1351.536;Inherit;False;Property;_BottomDay;BottomDay;12;0;Create;True;0;0;False;0;0.3086062,0.5836833,0.8962264,1;0.6431373,0.9607844,0.972549,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;322;-1444.034,1280.098;Inherit;False;211;DayTime01;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;313;-1009.893,842.5132;Inherit;False;Property;_TopNight;TopNight;11;0;Create;True;0;0;False;0;0.1365348,0.1089356,0.4528302,1;0,0.05487628,0.3490565,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;328;-1457.035,-119.2416;Inherit;False;955.925;504.6014;;5;332;331;330;329;384;Clouds Color;0.4834906,0.4928036,0.5,1;0;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;157;-738.679,-478.1717;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;311;-1429.675,684.2154;Inherit;False;Property;_TopDay;TopDay;9;0;Create;True;0;0;False;0;0.3806515,0.7481066,0.8867924,1;0,0.5507969,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;332;-1407.035,22.56198;Inherit;False;Property;_CloudsDay;CloudsDay;6;0;Create;True;0;0;False;0;0.7195621,0.8689173,0.9245283,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;331;-988.2518,180.8596;Inherit;False;Property;_CloudsNight;CloudsNight;8;0;Create;True;0;0;False;0;0.3064703,0.3758842,0.6698113,1;0.02723388,0.2857742,0.6415094,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;384;-683.2204,17.73687;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;312;659.4355,-2052.268;Inherit;False;Property;_SunsetColor;SunsetColor;10;0;Create;True;0;0;False;0;0.9528302,0.7971212,0.4629317,1;0.8018868,0.4295126,0.2307316,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;397;1097.729,-1700.598;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;383;1077.597,-1883.687;Inherit;False;3;0;COLOR;0,0,0,1;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;329;-1195.003,104.338;Inherit;False;Property;_CloudsTwi;CloudsTwi;7;0;Create;True;0;0;False;0;0.6603774,0.4799573,0.09656461,1;0.4528299,0.2221971,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;390;1490.616,-1346.491;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C9B1603D1B0FDCDBA0E0B23F828857C3FCC68233